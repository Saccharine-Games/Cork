...
namespace DistantLands.Cozy
{
    ...
    public class CozyWeather : CozyEcosystem
    {
        ...
        public MeridiemTime currentTime
        {
            ...
            set
            {
                ...
                if (timeControl == TimeControl.native)
                {
                    calendar.currentTicks = MeridiemTime.MeridiemTimeToDeyPercent(value);
                }
                else
                {
                    perennialProfile.currentTicks = MeridiemTime.MeridiemTimeToDeyPercent(value);
                }
    ...
    public class MeridiemTime : IEquatable<MeridiemTime>
    {
        ...
        public MeridiemTime(int hour, int minute, Meridiem meridiemType)
        {
            hours = hour;
            minutes = minute;
